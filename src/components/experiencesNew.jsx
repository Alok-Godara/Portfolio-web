...
const Experiences = () => {
  return (
    <section id="experience" className="w-full px-4 pb-5 flex flex-col items-center gap-8">
      ...
      <div className="w-full max-w-4xl bg-black/40 backdrop-blur-lg border border-white/10 rounded-xl p-6 shadow-lg">
        <h3 className="text-2xl font-semibold text-yellow-300"> 
          Web & App Developer
        </h3>
        <p className="text-gray-400">Project H • India</p>
        <p className="text-sm text-gray-500 mb-3">Feb 2025 – Oct 2025</p>
      ...
      <div className="w-full max-w-4xl bg-black/40 backdrop-blur-lg border border-white/10 rounded-xl p-6 shadow-lg">
        ...
        <p className="text-gray-400">IIT Jodhpur • India</p>
        <p className="text-sm text-gray-500 mb-3">Aug 2024 – Nov 2025</p>
